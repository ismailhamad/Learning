...
class Sign_Up : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        but_SignUp.setOnClickListener {
           learningViewModel.Sign_Up(users(auth.currentUser!!.uid,TextName_SignUp.text.toString(),TextLName_SignUp.text.toString(),Email_SignUp.text.toString(),Password_SignUp.text.toString()))
        }
